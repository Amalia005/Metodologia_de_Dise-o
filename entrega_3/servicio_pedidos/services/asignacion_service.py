...
class AsignacionService:
    ...
    Invocado tanto por el consumidor de la cola (automático)
    como por el endpoint manual POST /pedidos/<id>/asignar.
    Ambos caminos usan la misma lógica — no se duplica código."""
